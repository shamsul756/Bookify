...
const HeroPage = () => {
  return (
    <>
      <div className="hero min-h-[70vh] rounded-2xl my-5 mx-auto container bg-gradient-to-br from-cyan-200 via-white to-fuchsia-100 shadow-md">
        <div className="hero-content flex-col lg:flex-row-reverse w-full justify-between gap-10 px-6 py-10">
          ...
          <div className="space-y-5 max-w-xl text-center lg:text-left">
            ...
            {/* Divider */}
            <div className="flex">
            <div className="w-16 h-1 bg-gradient-to-r from-green-400 to-cyan-500 rounded-full mx-auto lg:mx-9" />
            <div className="w-16 h-1 bg-gradient-to-r from-green-400 to-cyan-500 rounded-full mx-auto lg:mx-8" />
            <div className="w-16 h-1 bg-gradient-to-r from-blue-600 to-cyan-900 rounded-full mx-auto lg:mx-5" />
</div>
            {/* Paragraph */}
